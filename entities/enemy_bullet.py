...
class EnemyBullet:
    ...
    def draw(self, surface: pygame.Surface, offset: pygame.Vector2):
        ...
        glow(surface, cx, cy, 14, (255, 60, 30), 90)
        pygame.draw.circle(surface, (255, 100, 60), (cx, cy), self.RADIUS)
        pygame.draw.circle(surface, (255, 200, 180), (cx, cy), max(1, self.RADIUS - 3))
